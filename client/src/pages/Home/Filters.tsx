...
const ages = [
  ...
  { name: '13+ years old', value: '13-20' }
]
const Filters = ({ showFilters, setShowFilters, filters, setFilters }) => {
  return (
    <div className='w-72 flex flex-col'>
      <div className='flex justify-between text-xl'>
        <h1 className='text-orange-900 text-xl font-bold'>Filters</h1>
      ...
      <div className='flex flex-col gap-3 mt-10'>
        ...
        <div className='flex flex-col gap-3 mt-8'>
          <h1 className='text-gray-600 text-lg'>Ages</h1>
                  ...
                  <input
                    ...
                    onChange={(e) => {
                      if (e.target.checked) {
                        setFilters({
                          ...filters,
                          category: [...filters.age, age?.value]
                        })
                      } else {
                        setFilters({
                          ...ages,
                          category: filters?.age?.filter((item) => item !== age.value)
                        })
                      }
                    }}
                  />
